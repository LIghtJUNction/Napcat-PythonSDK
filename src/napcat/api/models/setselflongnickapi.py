...
class Result(BaseModel):
    status: str = Field(default="ok", description="status字段, 默认为ok")
...
class SetSelfLongnickAPI(BaseModel):
    ...
    def __call__(self, req: SetSelfLongnickReq) -> SetSelfLongnickRes:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 SetSelfLongnickAPI API")
