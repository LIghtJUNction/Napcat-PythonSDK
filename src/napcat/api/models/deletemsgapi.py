...
class DeleteMsgReq(BaseModel):
    """撤回消息"""
    message_id: str = Field(description="标识ID")
...
class DeleteMsgAPI(BaseModel):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.logger.debug("初始化 DeleteMsgAPI")

    def __call__(self, req: DeleteMsgReq) -> DeleteMsgRes:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 DeleteMsgAPI API")
