...
class BotExitRes(BaseModel):
    ...
    data: ResponseData = Field(..., description="响应数据")
...
class BotExitAPI(BaseModel):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.logger.debug("初始化 BotExitAPI")

    def __call__(self, req: BotExitReq) -> BotExitRes:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 BotExitAPI API")
