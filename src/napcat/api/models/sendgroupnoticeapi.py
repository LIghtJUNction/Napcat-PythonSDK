...
class Result(BaseModel):
    ...
    data: dict = Field(default={}, description="data字段")
...
class SendGroupNoticeAPI(BaseModel):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.logger.debug("初始化 SendGroupNoticeAPI")

    def __call__(self, req: SendGroupNoticeReq) -> SendGroupNoticeRes:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 SendGroupNoticeAPI API")
