...
class SetGroupLeaveRes(BaseModel):
    ...
    data: ResponseData | None = Field(default_factory=lambda: SetGroupLeaveRes.ResponseData(), description="data字段")
...
class SetGroupLeaveAPI(BaseModel):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.logger.debug("初始化 SetGroupLeaveAPI")

    def __call__(self, req: SetGroupLeaveReq) -> Result:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 SetGroupLeaveAPI API")
