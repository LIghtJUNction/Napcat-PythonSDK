...
@tags: 消息相关/发送私聊消息
@homepage: https://api.napcat.com/226659051e0
@llms.txt: https://api.napcat.com/226659051e0.md
@version: 4.7.17
...
# response model
class ForwardFriendSingleMsgRes(BaseHttpResponse[ForwardFriendSingleMsgData]):
    """
