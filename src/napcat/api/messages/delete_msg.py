...
class DeleteMsgAPI(BaseHttpAPI):
    """
    撤回消息 API
    用于撤回已发送的消息，包括私聊消息和群消息
    接口地址: https://napcat.apifox.cn/226659108e0.md

    参数：
    {
      "message_id": "123456"  // 需要撤回的消息ID
    }
...
if __name__ == "__main__":
    ...
    # uv pip install -e . 
    # python -m napcat.api.messages.delete_msg
    test_model(Request)
