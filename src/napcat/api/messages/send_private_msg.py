...
class Request(BaseHttpRequest):
    ...
    发送私聊消息请求参数
    """
    user_id: int | str = Field(description="对方用户ID")
...
class SendPrivateMsgAPI(BaseHttpAPI):
    """
    发送私聊消息 API
    用于向指定好友发送私聊消息
    接口地址: https://napcat.apifox.cn/226659145e0.md
...
if __name__ == "__main__":
    ...
    # uv pip install -e . 
    # python -m napcat.api.messages.send_private_msg
    test_model(Request)
