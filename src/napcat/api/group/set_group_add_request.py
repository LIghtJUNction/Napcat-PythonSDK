...
@tags: 群聊相关
@homepage: https://api.napcat.com/226656947e0
@llms.txt: https://api.napcat.com/226656947e0.md
@version: 4.7.17
...
# response model
class SetGroupAddRequestRes(BaseHttpResponse[SetGroupAddRequestData]):
    """
