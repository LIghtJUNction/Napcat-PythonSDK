...
class MarkPrivateMsgAsReadAPI(BaseModel):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.logger.debug("初始化 MarkPrivateMsgAsReadAPI")

    def __call__(self, req: MarkPrivateMsgAsReadReq) -> MarkPrivateMsgAsReadRes:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 MarkPrivateMsgAsReadAPI API")
