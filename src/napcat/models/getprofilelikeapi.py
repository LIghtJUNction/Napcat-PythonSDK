...
class GetProfileLikeRes(BaseModel):
    ...
    class ResponseData(BaseModel):
        """响应数据类型"""
        total_count: float = Field(default=None, description="总点赞数")
        new_count: float = Field(default=None, description="新点赞数")
        new_nearby_count: float = Field(default=None, description="new_nearby_count字段")
        last_visit_time: float = Field(default=None, description="last_visit_time字段")
        userInfos: list[UserinfosItem] = Field(default=None, description="userInfos字段")
