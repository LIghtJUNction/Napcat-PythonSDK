...
class NcGetPacketStatusAPI(BaseModel):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.logger.debug("初始化 NcGetPacketStatusAPI")

    def __call__(self, req: NcGetPacketStatusReq) -> NcGetPacketStatusRes:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 NcGetPacketStatusAPI API")
