...
class ArksharegroupRes(BaseModel):
    ...
    data: ResponseData = Field(default_factory=lambda: ResponseData(), description="卡片json")
...
class ArksharegroupAPI(BaseModel):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.logger.debug("初始化 ArksharegroupAPI")

    def __call__(self, req: ArksharegroupReq) -> ArksharegroupRes:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 ArksharegroupAPI API")
