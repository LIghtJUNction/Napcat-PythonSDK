...
class GetCookiesRes(BaseModel):
    ...
    class ResponseData(BaseModel):
        ...
        bkn: str = Field(default=None, description="bkn字段")
...
class GetCookiesAPI(BaseModel):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.logger.debug("初始化 GetCookiesAPI")

    def __call__(self, req: GetCookiesReq) -> GetCookiesRes:
        """
        ...
        """
        # 调试日志
        self.logger.debug(f"调用 GetCookiesAPI API")
